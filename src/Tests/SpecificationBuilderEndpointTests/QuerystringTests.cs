...
namespace Tests.SpecificationBuilderEndpointTests
{
    public class QuerystringTests : TestBase
    {
        ...
        {
            var endpoint = _spec.GetEndpoint<Querystrings.ImplicitGetHandler>();

            endpoint.querystringParameters.Count.ShouldEqual(3);
            endpoint.HasQuerystring<Querystrings.Request>(x => x.Sort).ShouldBeTrue();
            endpoint.HasQuerystring<Querystrings.Request>(x => x.Sort).ShouldBeTrue();

            endpoint = _spec.GetEndpoint<Querystrings.ImplicitDeleteHandler>();
        ...
        {
            var endpoint = _spec.GetEndpoint<Querystrings.ExplicitPutHandler>();

            endpoint.querystringParameters.Count.ShouldEqual(2);
            endpoint.HasQuerystring<Querystrings.Request>(x => x.Sort).ShouldBeTrue();

            endpoint = _spec.GetEndpoint<Querystrings.ExplicitPostHandler>();
        ...
        {
            var parameter = _spec.GetEndpoint<Querystrings.ImplicitGetHandler>()
        ...
        {
            _spec.GetEndpoint<Querystrings.ImplicitGetHandler>()
        ...
        {
            var options = _spec.GetEndpoint<Querystrings.OptionGetHandler>()
        ...
        {
            var option = _spec.GetEndpoint<Querystrings.OptionGetHandler>()
        ...
        {
            _spec.GetEndpoint<Querystrings.OptionGetHandler>()
