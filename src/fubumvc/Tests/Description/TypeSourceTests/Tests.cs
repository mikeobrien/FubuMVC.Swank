...
namespace Tests.Description.TypeSourceTests
{
    [TestFixture]
    public class Tests
    {
        ...
        {
            var description = new TypeSource().GetDescription(typeof(List<AdminAddressResponse>));
        ...
        {
            var description = new TypeSource().GetDescription(typeof(AdminAddresses));
            description.Type.ShouldEqual(typeof(AdminAddressResponse));
            description.Name.ShouldEqual("ArrayOfAdminAddressResponse");
        ...
        {
            var description = new TypeSource().GetDescription(typeof(AdminUsers));
